...
class AddMovie extends React.Component {
  ...
  render() {
    ...
    return (
      <form>
        <fieldset>
          <label htmlFor="tlt">Título<input id="tlt" type="text" value={this.state.title}
          onChange={(e) => this.changeHandlerTitle(e)} /></label>
          <label htmlFor="sub">Subtítulo
            <input type="text" id="sub" value={this.state.subtitle} onChange={(e) => this.changeHandlerSubtitle(e)} /></label>
          <label htmlFor="img">Imagem
            <input type="text" id="img" value={this.state.imagePath} onChange={(e) => this.changeHandlerimagePath(e)} /></label>
          <label htmlFor="sps">Sinopse
            <textarea id="sps" value={this.state.storyline} onChange={(e) =>
              this.changeHandlerstoryline(e)} /></label>
          <label htmlFor="num">Avaliação
            <input id="num" type="number" value={this.state.rating} onChange={(e) => this.changeHandlerrating(e)} /></label>
