  ...
  render() {
    ...
    return (
      <form>
        ...
        <input type="text" name="search-bar" id="search-bar" value={this.props.searchText} onChange={this.props.onSearchTextChange} /></label>
        <label htmlFor="checkbox">Mostrar somente favoritos:
          <input type="checkbox" name="checkbox" id="checkbox" checked={this.props.bookmarkedOnly} onChange={this.props.onBookmarkedChange} /></label>
